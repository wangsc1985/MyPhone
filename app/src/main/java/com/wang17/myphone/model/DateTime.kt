...
class DateTime : GregorianCalendar {
    ...
    fun toShortDateString3(): String {
        return _String.concat(year, "年", monthStr, "月", dayStr, "日")
    }
    ...
    fun toShortDateString1(): String {
        return _String.concat(monthStr, "/", dayStr)
    }
    ...
    fun toLongDateTimeString1(): String {
        return _String.concat(toShortDateString(), "  ", hourStr, ":", miniteStr)
    }
    ...
    fun toTimeString(): String {
        return _String.concat(hourStr, ":", miniteStr, ":", secondStr)
    }
    ...
    fun toShortTimeString(): String {
        return _String.concat(hourStr, " : ", miniteStr)
    }
