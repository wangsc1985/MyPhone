...
public class GanZhi {
    ...
    private static final com.wang17.myphone.model.DateTime MINIMAL_DATE = new com.wang17.myphone.model.DateTime(1999, 1, 1, 1, 0, 0);
    private static com.wang17.myphone.model.DateTime MAXIMAL_DATE = new com.wang17.myphone.model.DateTime(2050, 12, 31, 22, 59, 59);

    private Map<com.wang17.myphone.model.DateTime, SolarTerm> solarTermMap;
    private com.wang17.myphone.model.DateTime DateTime;
    ...
    public static com.wang17.myphone.model.DateTime getMaximalDate() {
        return MAXIMAL_DATE;
    }

    public static com.wang17.myphone.model.DateTime getMinimalDate() {
        return MINIMAL_DATE;
    }
     ...
     */
    public GanZhi(com.wang17.myphone.model.DateTime dateTime, TreeMap<com.wang17.myphone.model.DateTime, SolarTerm> solarTermTreeMap) throws Exception {
    ...
    private void convertToGanZhi(com.wang17.myphone.model.DateTime dateTime) throws Exception {
        ...
        com.wang17.myphone.model.DateTime cal =new com.wang17.myphone.model.DateTime(2015,1,1);
        com.wang17.myphone.model.DateTime today = dateTime.getDate();
        int years = today.getYear() - 1955;

        for (Map.Entry<com.wang17.myphone.model.DateTime, SolarTerm> entry : this.solarTermMap.entrySet()) {
        ...
        // 月干支
        Map.Entry<com.wang17.myphone.model.DateTime, SolarTerm> nextSolarTerm = null;
        for (Map.Entry<com.wang17.myphone.model.DateTime, SolarTerm> entry : this.solarTermMap.entrySet()) {
            cal.set(entry.getKey().getYear(), entry.getKey().getMonth(), entry.getKey().getDay(), 0, 0, 0);
        ...
        com.wang17.myphone.model.DateTime normDateTime = new com.wang17.myphone.model.DateTime(1800, 0, 1, 0, 0, 0).addHours(-1);
