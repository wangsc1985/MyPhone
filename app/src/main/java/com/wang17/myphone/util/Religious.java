...
public class Religious {
    ...
    public Religious( int year, int month, TreeMap<DateTime, SolarTerm> solarTermTreeMap, ReligiousCallBack callBack) throws Exception {
    ...
    public Religious( int year, int month, int day, TreeMap<DateTime, SolarTerm> solarTermTreeMap, ReligiousCallBack callBack) throws Exception {
        this.solarTermTreeMap = solarTermTreeMap;
...
/*            for (MemorialDay memorialDay : memorialDays) {
            ...
            // 太岁日。犯之皆减寿一年。
            if ("丑".equals(ganzhi.getDiZhiDay())) {
...
//            }
    ...
    private void loadReligiousDays(int year, int month, int day, ReligiousCallBack callBack) throws Exception {
        ...
        DateTime chufuStartDate = today,
                chufuEndDate = today,
                zhongfuStartDate = today,
                zhongfuEndDate = today,
                mofuStartDate = today,
                mofuEndDate = today;
        ...
        /// 秋分 杀气浸盛。阳气日衰。宜从白露节禁起。戒过一月。
        /// 此二节之前三后三共七日。犯之必得危疾。尤宜切戒。
        Map.Entry<DateTime, SolarTerm> solar = find(today.addDays(-3), today.addDays(3), SolarTerm.春分);
        ...
        GanZhi ganzhi = new GanZhi(today, this.solarTermTreeMap);
        ...
        //　大小月，大月30天，小月30天
        int maxDay = lunar.getDay();
        DateTime tempday = today.addDays(1);
        Lunar tmpLunar = new Lunar(tempday);
        while (tmpLunar.getMonth() == lunar.getMonth()) {
            maxDay = tmpLunar.getDay();
            tempday = tempday.addDays(1);
        ...
        /// 犯之减寿五年。（农历正月十五、七月十五、十月十五，为上中下三元）
        if (chineseDay == 15 && chineseMonth == 1) {
            this.AddReligiousDay(today, "农历正月十五（三元日）。犯之减寿五年。");
        } else if (chineseDay == 15 && chineseMonth == 7) {
            this.AddReligiousDay(today, "农历七月十五（三元日）。犯之减寿五年。");
        } else if (chineseDay == 15 && chineseMonth == 10) {
            this.AddReligiousDay(today, "农历十月十五（三元日）。犯之减寿五年。");
        }

        /// 三伏日
        if (today.compareTo(chufuEndDate.getDate()) <= 0 && today.compareTo(chufuStartDate.getDate()) >= 0) {
            this.AddReligiousDay(today, "初伏。犯之减寿一年。");
        } else if (today.compareTo(zhongfuEndDate.getDate()) <= 0 && today.compareTo(zhongfuStartDate.getDate()) >= 0) {
            this.AddReligiousDay(today, "中伏。犯之减寿一年。");
        } else if (today.compareTo(mofuEndDate.getDate()) <= 0 && today.compareTo(mofuStartDate.getDate()) >= 0) {
            this.AddReligiousDay(today, "末伏。犯之减寿一年。");
        }
        ...
        if (tChineseDay == 17 || tChineseDay == 18) {
            if (maxDay == 30) {
                if (tChineseDay == 18) {
                    this.AddReligiousDay(today, "毁败日。犯之得病。");
                }
            } else {
                if (tChineseDay == 17) {
                    this.AddReligiousDay(today, "毁败日。犯之得病。");
        ...
        /// 上弦为初七初八，下弦为二十二二十三。犯之减寿一年。
        if (chineseDay == 7 || chineseDay == 8) {
            this.AddReligiousDay(today, "上弦日。犯之减寿一年。");
        } else if (chineseDay == 22 || chineseDay == 23) {
            this.AddReligiousDay(today, "下弦日。犯之减寿一年。");
        }

        if (new Lunar(today.addDays(1)).getDay() == 1) {
            this.AddReligiousDay(today, "本月最后一天（晦日）。犯之减寿一年。");
        }

        /// 每月三辛日，犯之减寿一年。
        if (ganzhi.getTianGanDay().equals("辛")) {
            this.AddReligiousDay(today, "每月三辛日。犯之减寿一年。");
        }
        /// 甲子日。庚申日。犯之皆减寿一年。
        else if (ganzhi.getTianGanDay().equals("甲") && ganzhi.getDiZhiDay().equals("子")) {
            this.AddReligiousDay(today, "甲子日。犯之皆减寿一年。");
        } else if (ganzhi.getTianGanDay().equals("庚") && ganzhi.getDiZhiDay().equals("申")) {
            this.AddReligiousDay(today, "庚申日。犯之皆减寿一年。");
        }
        /// 丙丁日。天地仓开日。犯之皆得病。
        else if (ganzhi.getTianGanDay().equals("丙") || ganzhi.getTianGanDay().equals("丁")) {
            this.AddReligiousDay(today, "丙丁日。天地仓开日。犯之皆得病。");
        }
        ...
        if (
            ...
            this.AddReligiousDay(today, "十恶大败日。此皆大不吉之日。宜戒");
        }
        ...
        // 农历戒期
        if (lunarReligiousDays.containsKey(new LunarDate(chineseMonth, chineseDay))) {
            this.AddReligiousDay(today, lunarReligiousDays.get(new LunarDate(chineseMonth, chineseDay)));
        }
...
/*            for (MemorialDay memorialDay : memorialDays) {
        ...
        // 太岁日。犯之皆减寿一年。
        if ("丑".equals(ganzhi.getDiZhiDay())) {
            this.AddReligiousDay(today, "本人太岁日。犯之减寿一年。");
        }
        /// 己身夫妇本命诞日。犯之皆减寿。
     /*       if (!_String.IsNullOrEmpty(this.zodiac2) && this.ZodiacToDizhi(this.zodiac2).equals(ganzhi.getDiZhiDay())) {
                this.AddReligiousDay(day, "配偶太岁日。犯之减寿一年。");
...
//            if (swith_szr) {
        if (maxDay == 30) {
            if (chineseDay == 1 || chineseDay == 8 || chineseDay == 14 || chineseDay == 15 || chineseDay == 18
                    || chineseDay == 23 || chineseDay == 24 || chineseDay == 28 || chineseDay == 29 || chineseDay == 30) {
                this.AddReligiousDay(today, "十斋日");
            }
        } else {
            if (chineseDay == 1 || chineseDay == 8 || chineseDay == 14 || chineseDay == 15 || chineseDay == 18
                    || chineseDay == 23 || chineseDay == 24 || chineseDay == 27 || chineseDay == 28 || chineseDay == 29) {
...
//            if (swith_gyz) {
        ...
        if (ggg) {
            this.AddReligiousDay(today, "观音斋");
        }
//            }
