...
class DateTime : GregorianCalendar {
    ...
    companion object {
        ...
        //            return second + "秒";
        //        }
        //        return String.concat(day > 0 ? day + "天" : "", hour > 0 ? hour + "小时" : "", minite > 0 ? minite + "分钟" : "", second > 0 ? second + "秒" : "");
        //    }
        /**
         * 格式：*天*小时*分钟
         *
        ...
        //            return minite + "分钟";
        //        }
        //        return String.concat(day > 0 ? day + "天" : "", hour > 0 ? hour + "小时" : "", minite > 0 ? minite + "分钟" : "");
        //    }
